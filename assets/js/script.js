  ...
  $(window).on("scroll load", function () {
    ...
    $("section").each(function () {
      ...
      if (top > offset && top < offset + height) {
        $(".navbar ul li a").removeClass("nav-link home active");
        $(".navbar").find(`[href="#${id}"]`).addClass("nav-link home active");
      }
    });
  });
...
document.addEventListener("visibilitychange", function () {
  if (document.visibilityState === "visible") {
    ...
    $("#favicon").attr("href", "assets/images/profile2.png");
  } else {
...
function showProjects(projects) {
  ...
  /* SCROLL PROJECTS */
  srtop.reveal(".project-card .box", { interval: 200 });
}
...
srtop.reveal(".home #contact-linkedin", { interval: 600 });
srtop.reveal(".home #contact-github", { interval: 800 });
...
srtop.reveal(".about .content .resume-link-2", { delay: 200 });
